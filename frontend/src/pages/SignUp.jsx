      ...
      <div className="max-w-6xl w-full relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white leading-[1.1] tracking-tighter">
            Your Vision, <br /> 
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">4 Years</span> in Making
          </h2>
          
          <p className="text-gray-400 text-lg font-light leading-relaxed max-w-md">
            I specialize in transforming complex requirements into elegant, high-performing digital experiences with over 4 years of freelance expertise.
          </p>
          ...
          <div className="border-t border-white/10 pt-8 flex items-start gap-6 max-w-md">
            ...
            <div>
              <p className="text-gray-400 italic text-sm leading-relaxed">
                "Consistently delivering premium quality for 4+ years. My goal is to exceed your expectations every single time."
              </p>
